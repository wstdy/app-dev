<template>
    <view :class="[border?'uni-forms-item--border':'' ,border && isFirstBorder?'is-first-border':'']"
          class="uni-forms-item">
        <view class="uni-forms-item__box">
            <view :class="['is-direction-' + localLabelPos]" class="uni-forms-item__inner">
                <slot name="label">
                    <view :class="{'no-label':!label && !isRequired}" class="uni-forms-item__label">
                        <!-- <view v-if="isRequired" class="required-star">*</view> -->
                        <text :class="isRequired ? 'is-required': 'not-required'">{{ label }}</text>
                    </view>
                </slot>
                <!-- #ifndef APP-NVUE -->
                <view class="uni-forms-item__content">
                    <slot></slot>
                    <view :class="{'msg--active':msg}" class="uni-forms-item__error">
                        <text>{{ msg }}</text>
                    </view>
                </view>
                <!-- #endif -->
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            isParagraph() {
                return this.formItemType === 'textarea' || this.componentType === 'upload'
            }
        ...
        methods: {
            ...
            // 处理 label 位置
            _labelPosition() {
                if (this.isParagraph) return 'top'
                if (this.form) return this.form.labelPosition || 'top'
                return 'top'
