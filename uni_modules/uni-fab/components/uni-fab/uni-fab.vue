<template>
	<view class="uni-cursor-point">
		...
		<view :class="{
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
		}" class="uni-fab__circle uni-fab__plus" :style="{  'bottom': nvueBottom }" @click="_onClick">
			<uni-icons class="fab-circle-icon" type="plusempty" :color="styles.iconColor" size="22"
...
<style lang="scss" >
	$uni-shadow-base:0 1px 5px 3px rgba($color: #5E95FF, $alpha: 0.3) !default;
