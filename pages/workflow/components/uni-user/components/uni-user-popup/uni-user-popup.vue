<template>
  ...
  >
    ...
    <template #footer>
      ...
      <view class="hr"></view>
      <custom-dialog-submit @tap="confirm" :title="'提交'"></custom-dialog-submit>
    </template>
  </custom-dialog>
</template>
...
import uniUserCardV2 from '../uni-user-card/uni-user-card.vue'
...
//   }
  state.selectedIds = [user.id]
  state.selectedList = [user]
}
